...
<link rel="stylesheet" href="{{ asset('vendor/adminlte/dist/css/eternal.css') }}">
    @stack('css')
    @yield('css')
@stop
...
@section('adminlte_js')
    ...
    <script src="{{ asset('vendor/adminlte/dist/js/eternal.js') }}"></script>
    {{-- <script src="{{ asset('vendor/adminlte/dist/js/eternal_ajax.js') }}"></script> --}}
    @stack('js')
    @yield('js')
@stop
